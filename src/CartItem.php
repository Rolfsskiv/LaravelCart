...
class CartItem implements Arrayable, Jsonable
{
    ...
    /**
     * Returns the formatted price without DISCOUNT.
     *
     * @param int    $decimals
     ...
     * @return string
     */
    public function discountPrice($decimals = null, $decimalPoint = null, $thousandSeperator = null)
    {
        return $this->numberFormat($this->discountPrice, $decimals, $decimalPoint, $thousandSeperator);
    }

    /**
     * Returns the formatted subtotal.
     * Subtotal is price for whole CartItem without DISCOUNT
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
     ...
     * Total is price for whole CartItem with DISCOUNT
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
     ...
     *
     * @param \LaravelRolf\Cart\Contracts\Buyable $item
     * @return void
     */
    ...
    public function __get($attribute)
    {
        ...
        if($attribute === 'total') {
            return ($this->qty * $this->price) - ($this->qty * $this->discount);
        }
    ...
    {
        return new self($item->getBuyableIdentifier($options), $item->getBuyableDescription($options), $item->getBuyablePrice($options), $item->getBuyableDiscount($options), $options);
    }
    /**
